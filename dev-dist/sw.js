...
define(['./workbox-137dedbd'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.tkk2qo1962o"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/api\.neshan\.org\/.*/i, new workbox.NetworkFirst({
    "cacheName": "neshan-api-cache",
  ...
  workbox.registerRoute(/^https:\/\/static\.neshan\.org\/.*/i, new workbox.CacheFirst({
    "cacheName": "neshan-static-cache",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 100,
